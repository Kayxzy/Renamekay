...
DB_NAME = os.environ.get("DB_NAME", "bimocahyo")
DB_URL = os.environ.get("DB_URL", "mongodb+srv://bimacahyo:bimacahyo1@cluster0.whncebw.mongodb.net/?retryWrites=true&w=majority")
