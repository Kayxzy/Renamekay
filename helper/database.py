...
DB_NAME = os.environ.get("DB_NAME", "xflskay15")
DB_URL = os.environ.get("DB_URL", "mongodb+srv://xflskay15:xflskay15@cluster0.sjgrnng.mongodb.net/?retryWrites=true&w=majority")
