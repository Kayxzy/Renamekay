...
DB_NAME = os.environ.get("DB_NAME", "Kayex")
DB_URL = os.environ.get("DB_URL", "mongodb+srv://Kayex:Kayex@cluster0.tup4a.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
